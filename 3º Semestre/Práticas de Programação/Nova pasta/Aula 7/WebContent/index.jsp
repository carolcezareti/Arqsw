        ...
        <form action="ManterCliente.do" method="post">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="pop" class="form-control" name="populacao" id="populacao" maxlength="15" placeholder="populacao obrigatória">
                </div>

                <div class="form-group col-md-6">
                    <label for="area">Área</label>
                    <input type="area" class="form-control" name="area" id="area" required maxlength="60" placeholder="area obrigatória">
                </div>
            </div>
            <hr />
